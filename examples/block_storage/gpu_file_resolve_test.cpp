...
// (future) device-side translations match what the legacy
// monolithic GPU-file path's `__get_nvmeofst` did.
//
...
// ----------------------------------------------------------------------------
// Reference: identical to the legacy `__get_nvmeofst` math,
